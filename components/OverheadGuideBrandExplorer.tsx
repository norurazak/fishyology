...
import { BRANDS } from "@/lib/overheadGuideData";
import OverheadGuideBrandPanel from "@/components/OverheadGuideBrandPanel";

export default function OverheadGuideBrandExplorer() {
  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16">
        {BRANDS.map((b) => (
          <OverheadGuideBrandPanel key={b.id} brand={b} active={activeId === b.id} />
        ))}
      </div>
    </div>
  );
