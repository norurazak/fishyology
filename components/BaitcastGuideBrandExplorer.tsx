...
import { BRANDS } from "@/lib/baitcastGuideData";
import BaitcastGuideBrandPanel from "@/components/BaitcastGuideBrandPanel";

export default function BaitcastGuideBrandExplorer() {
  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16">
        {BRANDS.map((b) => (
          <BaitcastGuideBrandPanel key={b.id} brand={b} active={activeId === b.id} />
        ))}
      </div>
    </div>
  );
