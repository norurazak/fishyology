...
import ReelGuideBrandPanel from "@/components/ReelGuideBrandPanel";

export default function ReelGuideBrandExplorer() {
  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16">
        {BRANDS.map((b) => (
          <ReelGuideBrandPanel key={b.id} brand={b} active={activeId === b.id} />
        ))}
      </div>
    </div>
  );
